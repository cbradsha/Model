function [T_i,rho_i,P_i,R,P_d,f,x_o,t_step,gamma,x_d,method,n,V_cv2_i,L_piston_max,g,D_piston,x_stroke,V_max,w_d,V_dead_valve,eta_motor,Ap,P_electric,x_max,leakage_on,mass_on,vibration_order,vibration_on,valve_dynamics_on,D_cv2,L_cv2,heat_transfer_on,h_2_s] = givens(num_inputs,txt_inputs)
